...
Integrated into ln-005 environment scanner. Validates: JSON syntax of hooks.json, script file existence, dependency availability (python3, jq). See `shared/references/hook_health_check.md`.
