...
Most skills have `diagram.html` (embedded Mermaid) + `shared/css/diagram.css` (86 of 108). See [Visual Documentation](README.md#-visual-documentation) in README.md.

## Available Skills

**108 skills** in 9 categories (0XX Shared/Research, 1XX Documentation, 2XX Planning, 3XX Task Management, 4XX Execution, 5XX Quality, 6XX Audit, 7XX Bootstrap, 10XX Orchestration). See [README.md](README.md#-features) for complete list.
...
All 108 skills documented in [README.md](README.md#-features) with workflows in each SKILL.md. Follow Orchestrator-Worker Pattern per [SKILL_ARCHITECTURE_GUIDE.md](docs/SKILL_ARCHITECTURE_GUIDE.md).
